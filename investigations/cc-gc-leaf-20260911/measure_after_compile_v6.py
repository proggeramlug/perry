...
def main():
    ...
    try:
        ...
        for number in range(1, 4):
            ...
            run(['python3', '-B', str(STAGE / 'profile_workload_v3.py'), '--app', str(APP),
        ...
        (STAGE / 'PROFILE_COMPLETE-v3.json').write_text(json.dumps({'profiles': 3, 'status': 'complete'}) + '\n')
