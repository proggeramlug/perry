...
OUT = STAGE / 'callsite-v3'
LOCK = Path('/root/rig9831/lock')
EXPECTED = {
 'parser-v2/callsite_census.py': 'd38dbe1a61d4028baeb7d216494eb0917bbb0c9a48e15dec731550b519ee9901',
...
def main():
 ...
 while True:
  try:LOCK.mkdir();break
   ...
   time.sleep(10)
 owner=f'cc-gcleaf-callsite-v3 {os.getpid()}'
 ...
 try:
  ...
  command(['python3','-B',str(STAGE/'parser-v2/callsite_census.py'),
  ...
  command(['python3','-B',str(STAGE/'callsite_supplement_v1.py'),'--result',str(OUT),
           ...
           '--parser-dir',str(STAGE/'parser-v2'),'--output',str(OUT/'root-shadow-supplement.json')],'supplement')
