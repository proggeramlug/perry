#!/usr/bin/env python3
"""Bind the census counter statics in the owned binary by exact ELF symbol.
...
WANTED = {
    ...
    'RETIRES': 'u64',
    'LIVE': 'i64',
    'CANONICAL_HANDLE_ADDR_FILTER': 'bitmap',
    # The same monotone filter type guards three other hot probes. Reading all
    # four in one row shows whether saturation is one site's accident or the
    # type's behaviour under a realistic workload.
